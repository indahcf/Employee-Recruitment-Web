                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form action="<?= route_to('register') ?>" method="post" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user <?php if (session('errors.no_hp')) : ?>is-invalid<?php endif ?>" name="no_hp" placeholder="No Handphone" value="<?= old('no_hp') ?>">
                                    </div>
