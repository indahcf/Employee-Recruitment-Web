                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="p-5">
                                <center>
                                    <img src="<?= base_url() ?>/img/logo_ultranesia.jpg" alt="" width="45px" class="mb-2">
                                </center>
                                ...
                                <form action="<?= route_to('login') ?>" method="post" class="user">
                                    ...
                                    <?php if ($config->validFields === ['email']) : ?>
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" name="login" placeholder="Email">
